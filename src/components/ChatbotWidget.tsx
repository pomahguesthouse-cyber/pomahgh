      ...
      {isOpen && <Card className={cn("fixed bottom-4 w-[90vw] sm:w-80 h-[480px] max-w-sm shadow-2xl z-50 flex flex-col", position)}>
        ...
        backgroundColor: settings.primary_color
          ...
          <ScrollArea className="flex-1 p-3">
            ...
            {messages.map((message, index) => <div key={index} className={cn("mb-3 flex", message.role === "user" ? "justify-end" : "justify-start")}>
            ...
            {isLoading && settings.show_typing_indicator && <div className="flex items-center gap-2 text-muted-foreground">
