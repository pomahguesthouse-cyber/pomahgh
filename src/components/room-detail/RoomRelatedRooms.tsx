...
export const RoomRelatedRooms = ({
  ...
  return <div className="mt-16">
      {isEditorMode ? <EditableText widgetId="related-rooms" field="title" value="Other Rooms You May Like" as="h2" className="text-3xl font-bold mb-8 text-center" /> : <h2 className="text-3xl font-bold mb-8 text-center font-sans" style={getElementStyles('related-rooms-title')}>Kamar Lainnya</h2>}
