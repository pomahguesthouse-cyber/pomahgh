...
export const FacilityCard = ({
  ...
  return <div className="flex flex-col items-center text-center p-3 sm:p-4 md:p-6 rounded-lg bg-card hover:shadow-lg transition-shadow">
  ...
  return <section id="amenities" className="pt-0 pb-20 bg-background">
      ...
      <div className="container mx-auto px-4">
        ...
        once: true
          ...
          {isEditorMode ? <EditableText widgetId="amenities" field="title" value={title} as="h2" className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-cinzel font-semibold text-foreground mb-3 sm:mb-4" /> : <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold mb-3 sm:mb-4 font-sans text-primary" style={getElementStyles('amenities-title')}>
              {title}
            </h2>}
          
          {/* Line with widget styling */}
          <div className="h-1 bg-primary mx-auto mb-4 sm:mb-6 border-0 border-primary" style={{
