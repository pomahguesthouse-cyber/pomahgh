...
export default function Header() {
  ...
  const menuItems = [
    ...
    { label: "Facilities", onClick: () => handleNav("amenities") },
    ...
    <>
      ...
      <header className="hidden md:block fixed top-0 left-0 right-0 z-50">
        ...
        >
          <div className="h-full flex items-center justify-between">
            ...
            <nav
              className={`
                flex items-center gap-10 text-white
      ...
      >
        <div
          ...
          "
        >
          {/* FONT MOBILE DIBESARKAN */}
          <nav className="flex flex-col items-center text-white text-lg font-semibold text-center">
            {menuItems.map((item, index) => (
              ...
              >
                <button onClick={item.onClick} className="py-3 hover:opacity-80">
                  {item.label}
                </button>
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-50">
        <div className="mx-auto max-w-sm">
          ...
          >
            ...
            {/* FONT MENU DIBESARKAN */}
            <button onClick={() => setIsMenuOpen(!isMenuOpen)} className="text-lg font-bold tracking-widest">
              MENU
            </button>
