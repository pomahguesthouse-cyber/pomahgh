  ...
  const content = (
    <div style={style} className={cn("flex", {
      ...
      <a
        ...
        className="inline-flex items-center gap-2 px-4 md:px-6 py-2.5 md:py-3 rounded-full text-white font-medium transition-colors hover:opacity-90 text-sm md:text-base"
