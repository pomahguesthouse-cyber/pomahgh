      ...
      {dates.map((date) => {
        ...
        const headerCell = (
          <th
            ...
            className={cn(
              "border-2 border-border p-0.5 md:p-1.5 text-center transition-colors relative backdrop-blur-md shadow-md",
          ...
          >
            ...
            {/* TODAY badge */}
            {isTodayDate && (
              <div className="absolute top-0 left-1/2 -translate-x-1/2 bg-blue-500 text-white text-[6px] md:text-[8px] px-1 md:px-1.5 py-0.5 rounded-b-full rounded-l-full rounded-r-full rounded-t-none font-bold shadow-md">
                TODAY
              </div>
            )}
