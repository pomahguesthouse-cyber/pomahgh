...
export const CalendarHeaderRow = ({
  ...
  return <tr className="bg-muted/50">
      ...
      const headerCell = <th key={date.toISOString()} className={cn("border-2 border-border p-0.5 md:p-1.5 text-center transition-colors relative backdrop-blur-md shadow-md", isHolidayOrWeekend ? "bg-red-100/70 dark:bg-red-950/40" : "bg-white/60 dark:bg-gray-800/60")} style={{
        width: cellWidth,
        minWidth: cellWidth,
        maxWidth: cellWidth
      }}>
