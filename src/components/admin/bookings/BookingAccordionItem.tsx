  ...
  return (
    <AccordionItem value={booking.id} className="border-0">
      ...
      >
        ...
        <TooltipProvider>
          <div className="hidden lg:grid grid-cols-[50px_120px_minmax(150px,1fr)_120px_60px_80px_100px_100px_50px_130px_130px_130px_120px] gap-1 w-full text-[13px] text-gray-700 font-roboto items-center">
      ...
      <AccordionContent className="p-0 bg-gray-50 border-b border-gray-200 font-roboto">
        <div className="sticky left-0 w-screen max-w-[100vw] lg:w-[calc(100vw-var(--sidebar-width,16rem))] px-4 pb-4 space-y-4 pt-4 border border-solid border-secondary-foreground">
          {/* Info Grid - 4 Columns */}
