  ...
  return (
    <AccordionItem value={booking.id} className="border-0">
      ...
      >
        ...
        <TooltipProvider>
          <div className="hidden lg:grid grid-cols-[40px_110px_minmax(140px,1fr)_110px_50px_70px_90px_90px_50px_100px_110px_110px_100px] gap-1 w-full text-[13px] text-gray-700 font-roboto items-center">
