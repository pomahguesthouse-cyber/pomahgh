...
const routePrefetchMap: Record<string, () => Promise<unknown>> = {
  ...
  "/admin/invoice-management":   () => import("@/pages/admin/AdminInvoiceManagement"),
  "/admin/rooms":                () => import("@/pages/admin/AdminRooms"),
  "/admin/promotions":           () => import("@/pages/admin/AdminPromotions"),
  "/admin/room-addons":          () => import("@/pages/admin/AdminRoomAddons"),
  "/admin/room-features":        () => import("@/pages/admin/AdminRoomFeatures"),
  "/admin/facilities":           () => import("@/pages/admin/AdminFacilities"),
  "/admin/hero-slides":          () => import("@/pages/admin/AdminHeroSlides"),
  "/admin/facility-hero-slides": () => import("@/pages/admin/AdminFacilityHeroSlides"),
  "/admin/explore-hero-slides":  () => import("@/pages/admin/AdminExploreHeroSlides"),
  "/admin/nearby-locations":     () => import("@/pages/admin/AdminNearbyLocations"),
  "/admin/city-attractions":     () => import("@/pages/admin/AdminCityAttractions"),
  "/admin/city-events":          () => import("@/pages/admin/AdminCityEvents"),
  ...
  "/admin/page-editor":          () => import("@/pages/PageEditorPage"),
