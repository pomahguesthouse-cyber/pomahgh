...
import { Home, Calendar, Building2, ImageIcon, Boxes, Settings, MessageCircle, MapPin, CreditCard, Tags, RefreshCw, LayoutDashboard, Search, FileText, Compass, ChevronRight, ChevronDown, Sparkles, Percent, TrendingUp, Bot, Users, Shield } from "lucide-react";
...
const menuGroups: MenuGroup[] = [
  ...
  },
  {
    label: "Operations",
    items: [
      { title: "Analisis Harga", url: "/admin/competitor-analysis", icon: TrendingUp },
  ...
  },
  {
    label: "System",
    items: [
      { title: "Asisten Booking", url: "/admin/chat", icon: Bot },
      { 
  ...
  const renderMenuItem = (item: MenuItem) => {
    ...
    if (item.submenu) {
      ...
      return (
        <Collapsible 
          key={item.title} 
          open={isVAOpen || isAnySubActive}
          onOpenChange={setIsVAOpen}
        >
          <SidebarMenuItem>
