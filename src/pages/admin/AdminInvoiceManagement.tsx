...
import { Settings as SettingsIcon, Palette, ListChecks, MessageCircle, Bot } from "lucide-react";
    ...
    <div className="container mx-auto p-4 sm:p-6 max-w-7xl">
      <div className="mb-6">
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Kelola invoice, pembayaran, otomatisasi WhatsApp & verifikasi OCR di satu tempat.
        </p>
      </div>

      <Tabs value={tab} onValueChange={setTab} className="space-y-4">
        <TabsList className="grid grid-cols-2 sm:grid-cols-5 h-auto sm:h-10">
