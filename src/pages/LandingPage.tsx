...
export default function LandingPage() {
  ...
  const whatsappNumber = page.whatsapp_number || (hotelSettings?.whatsapp_number as string) || "";
  ...
  const schemaData = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        about: { "@id": `${window.location.origin}/#lodgingbusiness` },
  ...
  return (
    <>
      ...
      <main className="min-h-screen">
        {hasVisualSchema ? (
          /* ===== VISUAL EDITOR MODE ===== */
          <PublicPageRenderer elements={page.page_schema!} />
        ) : (
          /* ===== LEGACY MODE ===== */
          <LegacyLandingPageContent page={page} whatsappUrl={whatsappUrl} />
        )}
      </main>
...
/* Legacy layout extracted into its own component for clarity */
function LegacyLandingPageContent({ page, whatsappUrl }: { page: LandingPageData; whatsappUrl: string }) {
    ...
    <>
      ...
      <section className="py-20 md:py-28 bg-gradient-to-br from-primary via-primary to-primary/90 text-primary-foreground relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <Button size="lg" variant="secondary" className="gap-2 text-base md:text-lg px-8 py-6 shadow-xl hover:shadow-2xl transition-all hover:scale-105" asChild>
            <a href={whatsappUrl} target="_blank" rel="noopener noreferrer">
              <MessageCircle className="h-5 w-5 md:h-6 md:w-6" />
              {page.cta_text || "Booking via WhatsApp"}
            </a>
