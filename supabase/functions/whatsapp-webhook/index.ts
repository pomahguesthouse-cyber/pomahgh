...
// Negative sentiment keywords for Indonesian WhatsApp messages
...
/**
 * Fire-and-forget: detect negative sentiment and alert super admin managers via WhatsApp
 */
function detectAndAlertNegativeSentiment(
  userMessage: string,
  phone: string,
  guestName: string | null | undefined,
  managerNumbers: Array<{phone: string; name: string; role?: string}>,
  fonnteApiKey: string,
...
🔗 Conversation ID: ${conversationId || '-'}`;
  ...
  // Send to all super admins — fire and forget (no await)
